defmodule LdapWrapper do
  ...
  def convert_eldap_entry_to_map({:eldap_entry, dn, entry}) do
    entry
    |> Enum.into( %{:dn => convert_from_erlang(dn)},
