defmodule RobbyWeb.Emailer do
  ...
  def send_profile_picture_complaint(recipient_email) do
    %Mailman.Email{
      ...
      to: [recipient_email],
      text: """
      Your profile picture could use a refresh.  Please follow this link to upload a new photo: #{
        RobbyWeb.Router.Helpers.settings_profile_url(RobbyWeb.Endpoint, :edit)
      }\n
      \n
      Thank You!\n
      \n
      ...
      <html>
      <body>
      <p>Your profile picture could use a refresh.  Please visit <a href="#{
        RobbyWeb.Router.Helpers.settings_profile_url(RobbyWeb.Endpoint, :edit)
      }">your profile in Robby</a> to upload a better picture.</p>
      <p>Thank You!</p>
      ::Robby::
      </body>
      </html>
