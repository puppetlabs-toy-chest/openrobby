defmodule RobbyWeb.SettingsProfileView do
  ...
  @unwritable [:uid, :cn, :title, :ou, :manager, :hasSubordinates, :st, :l, :countryName, :stateOrProvincename, :mail]
  ...
  for att <- @lists do
    ...
    def render_input(form, unquote(att), value) do
      render __MODULE__, "list_input_partial.html", form: form, attribute: unquote(att), value: value
    end
  end
