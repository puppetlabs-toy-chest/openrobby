defmodule RobbyWeb.ProfileView do
  ...
  @links [:mail, :mobile, :manager, :steamAccount, :github, :telephoneNumber, :twitterHandle, :hasSubordinates, :uid]
  ...
  for key <- @lists do
    ...
    def render_attribute(unquote(key), %{unquote(key) => value}) when not is_nil(value) and is_list(value) do
