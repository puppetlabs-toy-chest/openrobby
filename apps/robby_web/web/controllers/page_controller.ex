defmodule RobbyWeb.PageController do
  ...
  defp sort_directory(people, %{"sort_by" => "startDate"}),
    do: Enum.sort_by(people, & &1.startDate)

  defp sort_directory(people, %{"sort_by" => sort_by}),
    do: Enum.sort_by(people, &Map.get(&1, String.to_existing_atom(sort_by)))
