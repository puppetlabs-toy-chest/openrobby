defmodule RobbyWeb.ExAws.S3.Sandbox do
  ...
  def put_object(_s3_bucket, "clippy.jpg", _source, _opts),     do: {:error, amazon_response("clippy.jpg")}
  def put_object(_s3_bucket, "jim.jpg", _source, _opts), do: {:error, amazon_response("jim.jpg")}
  def put_object(_s3_bucket, _destination, _source, _opts),     do: "This is clearly quite unexpected."
