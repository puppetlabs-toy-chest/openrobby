defmodule RobbyWeb.PasswordChangeControllerTest do
  ...
  test "updates user salt in repository for valid user", %{conn: conn, repo_user: repo_user} do
    ...
    |> fetch_session
    |> post(password_change_path(conn, :create), %{
      "password_change" => %{
        "new_password" => "doggbuttttttt2",
        "confirm_new_password" => "doggbuttttttt2",
        "old_password" =>
          "ggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg"
      }
    })
  ...
  test "throws error on change if invalid old password", %{conn: conn} do
    conn =
      ...
      |> post(password_change_path(conn, :create), %{
        "password_change" => %{
          "new_password" => "doggbuttttt2",
          "confirm_new_password" => "doggbuttttt2",
          "old_password" => "wrong_old_passw0rd"
        }
      })
  ...
  test "throws error on change if new password doesnt have enough char classes", %{conn: conn} do
    conn =
      ...
      |> post(password_change_path(conn, :create), %{
        "password_change" => %{
          "new_password" =>
            "doggbutttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt",
    ...
    conn =
      ...
      |> post(password_change_path(conn, :create), %{
        "password_change" => %{
          "new_password" =>
            "doggbutttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt",
          "confirm_new_password" => "something_else",
          "old_password" =>
            "ggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg"
        }
      })
  ...
  test "updates user password if valid", %{conn: conn} do
    conn =
      ...
      |> post(password_change_path(conn, :create), %{
        "password_change" => %{
          "new_password" => "doggbuttttt11",
          "confirm_new_password" => "doggbuttttt11",
          "old_password" =>
            "ggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg"
        }
      })
